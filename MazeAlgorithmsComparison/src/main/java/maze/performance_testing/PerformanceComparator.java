...
public class PerformanceComparator {
    /**
     * A class that generates mazes using the recursive backtracker method.
     */
    private RecursiveBacktracker rec;
    /**
     * A class that generates mazes using the Kruskal method.
     */
    private KruskalMaze k;
    /**
     * A class that solves mazes using the dead-end filling method.
     */
    private DeadEndFilling deadEnd;
    /**
     * A class that solves mazes using depth-first search.
     */
    private DepthFirstSearch depth;
    /**
     * A two-dimensional character array that the generated mazes are copied to.
     */
    private char[][] maze;
    /**
     * This value becomes the generated maze's width and height.
     */
    private final int mazeSize;
    
    /**
     * The recursive backtracker method's average performance time.
     */
    private long recTime;
    /**
     * The Kruskal generator's average performance time.
     */
    private long kruskalTime;
    /**
     * An array used for storing the dead-end filling metod's test results when
     * it solves mazes generated by the recursive backtracker.
     */
    private final long[] recDead;
    /**
     * An array used for storing the dead-end filling metod's test results when
     * it solves mazes generated by the Kruskal generator.
     */
    private final long[] krusDead;
    /**
     * An array used for storing the depth-first search's test results when it
     * solves mazes generated by the recursive backtracker.
     */
    private final long[] recDepth;
    /**
     * An array used for storing the depth-first search's test results when
     * it solves mazes generated by the Kruskal generator.
     */
    private final long[] krusDepth;

    /**
     * A constructor where all the variables are initialized.
     */
    ...
    /**
     * Gathers data on long it takes for the maze solving algorithms to solve
     * mazes generated using the recursive backtracker method.
     */
    ...
    /**
     * Gathers data on long it takes for the maze solving algorithms to solve
     * mazes generated by the Kruskal generator.
     */
